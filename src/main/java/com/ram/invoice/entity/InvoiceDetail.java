...
public class InvoiceDetail extends PanacheEntityBase implements Serializable {
    ...
    @SequenceGenerator(name = "seq_invoice_detail_id", sequenceName = "seq_invoice_detail_id", allocationSize = 1)
    @GeneratedValue(generator = "seq_invoice_detail_id", strategy = GenerationType.SEQUENCE)
    ...
    public int hashCode() {
        ...
        result = prime * result + ((revenuEndDate == null) ? 0 : revenuEndDate.hashCode());
        result = prime * result + ((revenueStartDate == null) ? 0 : revenueStartDate.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (familyCaseId == null) {
            ...
            return false;
        if (Double.doubleToLongBits(invoiceAmount) != Double.doubleToLongBits(other.invoiceAmount))
            return false;
        if (invoiceStatus == null) {
            ...
            return false;
        if (medicaidId == null) {
            if (other.medicaidId != null)
                return false;
        } else if (!medicaidId.equals(other.medicaidId))
            return false;
        if (revenuEndDate == null) {
            if (other.revenuEndDate != null)
                return false;
        } else if (!revenuEndDate.equals(other.revenuEndDate))
            return false;
        if (revenueStartDate == null) {
            if (other.revenueStartDate != null)
                return false;
        } else if (!revenueStartDate.equals(other.revenueStartDate))
            return false;
        if (seqInvoiceHeaderId != other.seqInvoiceHeaderId)
            return false;
        if (seqRateId != other.seqRateId)
            return false;
    ...
    public static List<InvoiceDetail> findRetroInvoices(String planName) {
    ...
    /**
     * Save the invoices list.
     * 
     * @param invoiceDetails
     */
    public static void saveInvoices(List<InvoiceDetail> invoiceDetails) {
        Iterator<InvoiceDetail> it = invoiceDetails.iterator();
        InvoiceDetail inv = null;
        try {
            while (it.hasNext()) {
                inv = (InvoiceDetail) it.next();
                saveInvoice(inv);
            }
            /*
             * invoiceDetails.stream().forEach(inv -> { saveInvoice(inv); });
             */
        } catch (Exception ex) {
            System.out.println(inv.seqInvoiceHeaderId + " : " + inv.seqInvoiceDetailId + " : " + inv.subscriberId
                    + " : " + inv.revenueStartDate);
            System.out.println("1 - " + ex.getClass() + " : " + ex.getCause());
        }
        // persist(invoiceDetails.stream());
    }

    @Transactional(value = TxType.REQUIRES_NEW)
	public static void saveInvoice(InvoiceDetail inv) {
        try {
        	String query = " seqInvoiceDetailId = :seqInvoiceDetailId ";
    		Map<String, Object> params = new HashMap<>();
    		params.put("seqInvoiceDetailId", inv.seqInvoiceDetailId);
    		if(0 == InvoiceDetail.count(query, params)) {
    			inv.persist();
    		}
            //inv.persist();
        	...
        	//TransactionManager.transactionManager().commit();
             ...
             System.out.println(" in saveInvoice - " + ex.getClass() + " : " + ex.getCause());
             ex.printStackTrace();
        }
    }
    ...
    public static List<InvoiceDetail> getInvoiceDetails(String queryString, Map<String, Object> params) {
        return list(queryString, params);
    }

    public Long getSeqInvoiceDetailId() {
        return seqInvoiceDetailId;
    }

    public void setSeqInvoiceDetailId(Long seqInvoiceDetailId) {
        this.seqInvoiceDetailId = seqInvoiceDetailId;
    }

    public Long getSeqRevenueId() {
        return seqRevenueId;
    }

    public void setSeqRevenueId(Long seqRevenueId) {
        this.seqRevenueId = seqRevenueId;
    }
    ...
    public Date getRevenuEndDate() {
        return revenuEndDate;
    }

    public void setRevenuEndDate(Date revenuEndDate) {
        this.revenuEndDate = revenuEndDate;
    }
